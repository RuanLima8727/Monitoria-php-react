...
<main style="height:90vh; background-color:#ccc; padding-top:5vh" >
    ...
    <script>
        var ctx = document.getElementById("myChart").getContext('2d');var myChart = new Chart(ctx, {type: 'pie',data: {labels: ['Monitores', 'Alunos'],datasets: [{data: [2, 114],backgroundColor: ['red','yellow']}]}});
    </script>
